...
<script>
    ...
    export default {
        ...
        created(){
            ...
            const _this = this
            axios.get('http://localhost:8000/order/detail/'+this.$route.query.orderId).then(function (resp) {
        ...
        methods: {
            onSubmit:function () {
                const _this = this
                 axios.put('http://localhost:8000/order/pay/'+this.$route.query.orderId).then(function (resp) {
                     if(resp.data.code == 0){
